...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.7/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Apr 2017 09:46:41 GMT -->
<head>
...
<body>
                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="{{ route('college.index') }}">Colleges</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="footer fixed">
                    <div>
                        <strong>Copyright</strong> SIMS &copy; 2017
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="{{ URL::asset('js/inspinia.js') }}" type="text/javascript"></script>
     <script src="{{ URL::asset('js/sims.js') }}" type="text/javascript"></script>
